...
output: pdf_document
#date: "Report generated on `r Sys.Date()` from https://apps.gis.colostate.edu/MAP-FRAC-Database/"
params:
  mag_file: NA
  data: NA
...
::: {.center data-latex=""}
Report generated on `r Sys.Date()` from <https://apps.gis.colostate.edu/MAP-FRAC-Database/>
:::
...
-   Please see [https://github.com/kkamundson/shale_biogeo/tree/main/MAG_linking_tool](https://github.com/kkamundson/shale_biogeo/tree/main/MAG_linking_tool) for detailed information on how linkages are made between ASVs and MAGs. 
...
This plot shows the proportion of the microbial community that encodes the inferred potential for sulfide production from either sulfate or thiosulfate as a result of ASV-MAG linking. The potential for sulfide production through different pathways is displayed: rhodanase (thiosulfate reduction), thiosulfate reductase (phsA, thiosulfate reduction), and dissimilatory sulfite reductase (dsrB, sulfate reduction). Here, ‘NA’ indicates the proportion of the community that did not link to a MAG and therefore no inferred genomic potential is available. 
